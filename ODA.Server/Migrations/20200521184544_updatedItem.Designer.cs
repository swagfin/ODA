...
namespace ODA.Server.Migrations
{
    ...
    [Migration("20200521184544_updatedItem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ODA.Server.Entity.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ODA.Server.Entity.Item", b =>
                {
            ...
            modelBuilder.Entity("ODA.Server.Entity.ItemCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ODA.Server.Entity.MapPopularPlace", b =>
                {
            ...
            modelBuilder.Entity("ODA.Server.Entity.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ODA.Server.Entity.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ODA.Server.Entity.Restaurant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ODA.Server.Entity.Item", b =>
                {
                    b.HasOne("ODA.Server.Entity.Restaurant", "Restaurant")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("ODA.Server.Entity.Order", b =>
                {
                    b.HasOne("ODA.Server.Entity.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("ODA.Server.Entity.OrderItem", b =>
                {
                    b.HasOne("ODA.Server.Entity.Item", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId");

                    b.HasOne("ODA.Server.Entity.Order", null)
                        .WithMany("OrderItems")
