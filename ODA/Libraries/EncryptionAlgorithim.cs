...
{
    public class EncryptionAlgorithim
    {
        ...
        {
            return string.Format("$salts.{1}.!o76tygh4rjk5to9df1ygh4rjk3poeriuy3$@~Hash_POSv1.com${0}$", "SemanticPOS.DesktopTouchScreen", "ODA");
        }
